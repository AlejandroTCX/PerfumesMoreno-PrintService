...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    body{font-family:'Courier New',monospace;font-size:12px;width:80mm;padding:1mm 0 0 0;margin:0;display:flex;justify-content:center;-webkit-print-color-adjust:exact;print-color-adjust:exact}
    body>*{width:100%;max-width:77mm;margin:0 auto;text-align:center}
